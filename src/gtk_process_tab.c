...
int process_tab_update(ProcessTab* self, ProcessList* process_list) {
    ...
    RETURN_INT_IF_ARG_IS_NULL("process_tab_update", self, "process_tab");
    RETURN_INT_IF_ARG_IS_NULL("process_tab_update", process_list, "process_list");
