...
void status_bar_update(StatusBar* status_bar, const size_t process_count, const long cpu_usage, const long memory_usage) {
...
void status_bar_set_process_count(StatusBar* status_bar, const size_t process_count) {
...
void status_bar_set_cpu_usage(StatusBar* status_bar, const long cpu_usage) {
